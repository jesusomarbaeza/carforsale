...
Mileage entries in the file set are not perfectly linear and likely reflect a recording anomaly, odometer reset, speedometer change, or similar restoration-era discrepancy common in older vehicles. The records remain useful for service history even where mileage reporting varies.

## One-Paragraph Listing Copy (Optional)

This 1971 Plymouth Scamp comes with a strong documentation package showing years of real-world maintenance and restoration. The file set includes over $9,300 in high-confidence receipts across paint/body, interior, chrome, wheels/tires, and mechanical work, plus supporting documentation for performance-oriented components from respected brands. The 2007 restoration period is especially well documented, with professional paint, interior refresh, trim work, and follow-up service records. For buyers who value proof of care, this car offers a rare, organized paper trail that helps separate it from typical undocumented classics.
